            ...
            <div class="flex items-center gap-3">
                @auth
                    ...
                    class="inline-flex items-center gap-2 whitespace-nowrap
                            bg-blue-600 text-white px-6 py-2.5 rounded-xl text-xs font-bold
                            shadow-xl shadow-blue-600/20 hover:bg-blue-700 hover:-translate-y-0.5 transition-all">
                    ...
                    <button type="submit"
                        class="inline-flex items-center gap-2 whitespace-nowrap
                            bg-slate-900 text-white px-6 py-2.5 rounded-xl text-xs font-bold
                            shadow-xl hover:bg-slate-800 transition-all">
