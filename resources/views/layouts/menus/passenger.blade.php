...
@section('sidebar-menu')
    @include('layouts.partials.nav-item', ['route' => 'navigasi.index', 'icon' => 'home', 'label' => 'Beranda'])
...
{{-- Mobile Items --}}
@section('mobile-menu')
    @include('layouts.partials.mobile-nav-item', ['route' => 'navigasi.index', 'icon' => 'home', 'label' => 'Beranda'])
