...
@section('sidebar-menu')
    ...
    @include('layouts.partials.nav-item', ['route' => 'driver.tracking.index', 'icon' => 'signpost', 'label' => 'Cek Jalur'])
...
@section('mobile-menu')
    ...
    @include('layouts.partials.mobile-nav-item', ['route' => 'driver.tracking.index', 'icon' => 'signpost', 'label' => 'Cek Jalur'])
