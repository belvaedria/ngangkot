...
@section('title', 'Edukasi Driver - Ngangkot')
...
<div class="flex-1 overflow-y-auto custom-scroll p-6 md:p-10">
    <div class="max-w-6xl mx-auto">
        ...
        <div class="text-center mb-16">
            <h1 class="text-4xl font-extrabold text-slate-900 mb-4">Edukasi Driver.</h1>
            <p class="text-slate-600 text-lg mb-8">Panduan dan tips untuk menjadi pengemudi angkot profesional.</p>
            
            <div class="max-w-2xl mx-auto relative">
                <input type="text" 
                       id="searchInput"
                       placeholder="Cari panduan driver..." 
        ...
        <div id="cardsContainer" class="grid md:grid-cols-3 gap-8">
            ...
            <div class="card-item col-span-3 text-center py-12" data-category="tips">
                ...
                <p class="text-slate-500">Tips untuk driver akan segera ditambahkan.</p>
            </div>
            @endforelse
            ...
            <div class="card-item col-span-3 text-center py-12" data-category="panduan">
                ...
                <p class="text-slate-500">Panduan untuk driver akan segera ditambahkan.</p>
            </div>
            @endforelse
